...
public class ClaimIndDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        claim_id = getIntent().getIntExtra("claim_id", -1);
        TextView claimText = findViewById(R.id.claim_text_details);
        claimText.setText(claims[claim_id-1]);//Index from 0 in array and claim ids start at 1 (sorry used to python now)
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int[] checkboxes = new int[6];
                checkboxes[0] = claim_id;
